...
- **Latest update:** 2026-03-20 (wave 22 summary)
- **Notes:** 202/583 items sorry_free (34.6%). ~87 sorry occurrences across 30 files. ~320 PRs merged across twenty-two proof waves. Four chapters at 100% formal completion: Ch3, Ch4, Ch7, Ch8. Wave 22 was the largest yet (46 PRs) and reversed the sorry trend: net -7 sorries (94→87). Key completions: GL2ConjugacyClasses.lean fully proved (all 4 cardinalities), GNW Property 1 proved, Young's Rule character identity proved, Dynkin classification nearly complete (1 sorry in forward direction). Remaining work concentrated in Ch5 (43 sorries across 15 files) and Ch6 (33 sorries across 10 files). See `progress/summaries/wave-22-summary.md` for full details.
