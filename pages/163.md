...
$$
x \in V_3, \quad x = (x_1, x_2), \quad x_1 \in V_1, \, x_2 \in V_2.
$$
...
So we can think of $V_3$ as the graph of an isomorphism $A : V_1 \to V_2$. From this we obtain the decomposition
